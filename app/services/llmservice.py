...
from app.core.config import HAR_ANALYSIS_PROMPT
...
class LLMService:
    ...
    def identify_request(
        ...
        prompt = HAR_ANALYSIS_PROMPT.format(
            description=description, requests=json.dumps(request_summaries, indent=2)
        )
